...
const CACHE_VERSION = ‘bay-shows-v6’;
...
// Apps Script Web App (bay_shows_merged data) — network first, cache on success.
// script.google.com returns CORS headers so this works without auth.
